...
import com.hualing.rider.overlayutil.BikingRouteOverlay;
import com.hualing.rider.overlayutil.DrivingRouteOverlay;
import com.hualing.rider.overlayutil.OverlayManager;
import com.hualing.rider.overlayutil.TransitRouteOverlay;
import com.hualing.rider.overlayutil.WalkingRouteOverlay;
import android.app.Activity;
import android.os.Bundle;
 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class DriverMenuActivity extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentMode = LocationMode.COMPASS; requestLocButton.setText("罗盘");
    ...
    public void nodeClick(View v) {
        ...
        if (step instanceof DrivingRouteLine.DrivingStep) {
            nodeLocation = ((DrivingRouteLine.DrivingStep) step).getEntrance().getLocation(); nodeTitle = ((DrivingRouteLine.DrivingStep) step).getInstructions();
        }
        else if (step instanceof WalkingRouteLine.WalkingStep) {
            nodeLocation = ((WalkingRouteLine.WalkingStep) step).getEntrance().getLocation(); nodeTitle = ((WalkingRouteLine.WalkingStep) step).getInstructions();
        }
        else if (step instanceof TransitRouteLine.TransitStep) {
            nodeLocation = ((TransitRouteLine.TransitStep) step).getEntrance().getLocation(); nodeTitle = ((TransitRouteLine.TransitStep) step).getInstructions();
        }
        else if (step instanceof BikingRouteLine.BikingStep) {
            nodeLocation = ((BikingRouteLine.BikingStep) step).getEntrance().getLocation(); nodeTitle = ((BikingRouteLine.BikingStep) step).getInstructions();
        }
        ...
        // show popup
        popupText = new TextView(DriverMenuActivity.this);
    ...
    public void MyToast(String s) {
        Toast.makeText(DriverMenuActivity.this, s, Toast.LENGTH_SHORT).show();
    }
