...
public class DaiSongDaEntity {

    private int code;
    private String message;
    private List<DaiSongDaEntity.DataBean> data;
    ...
    public List<DaiSongDaEntity.DataBean> getData() {
        return data;
    }

    public void setData(List<DaiSongDaEntity.DataBean> data) {
        this.data = data;
    }
